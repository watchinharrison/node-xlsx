...
function xlsx(file) { 
	...
	var result, zip = new JSZip(), zipTime, processTime, s, f, i, j, k, l, t, w, n, o, p, q, sharedStrings, styles, index, data, data_validation, val, style, borders, border, borderIndex, fonts, font, fontIndex,
