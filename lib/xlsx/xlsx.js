			...
			while (++n < o) {
				...
				while (++p < q) {
					...
					if (["list","custom"].indexOf(valid.type) != -1) validations.push('<dataValidation type="'+valid.type+'" errorStyle="'+type+'" allowBlank="0" showDropDown="0" showInputMessage="1" showErrorMessage="1" errorMessage="'+message+'" promptTitle="'+title+'" errorTitle="'+title+'" sqref="'+numAlpha(p)+ (n+1) +'"><formula1>'+source+'</formula1></dataValidation>');
						...
						if (criteria=="between") validations.push('<dataValidation type="'+valid.type+'" errorStyle="'+type+'" operator="between" allowBlank="0" showDropDown="0" showInputMessage="1" showErrorMessage="1" errorMessage="'+message+'" promptTitle="'+title+'" errorTitle="'+title+'" sqref="'+numAlpha(p)+ (n+1) +'"><formula1>'+valid.minimum+'</formula1><formula2>'+valid.maximum+'</formula2></dataValidation>');
						else if (criteria=="not between") validations.push('<dataValidation type="'+valid.type+'" errorStyle="'+type+'" operator="notBetween" allowBlank="0" showDropDown="0" showInputMessage="1" showErrorMessage="1" errorMessage="'+message+'" promptTitle="'+title+'" errorTitle="'+title+'" sqref="'+numAlpha(p)+ (n+1) +'"><formula1>'+valid.minimum+'</formula1><formula2>'+valid.maximum+'</formula2></dataValidation>');
						else if (criteria==">") validations.push('<dataValidation type="'+valid.type+'" errorStyle="'+type+'" operator="greaterThan" allowBlank="0" showDropDown="0" showInputMessage="1" showErrorMessage="1" errorMessage="'+message+'" promptTitle="'+title+'" errorTitle="'+title+'" sqref="'+numAlpha(p)+ (n+1) +'"><formula1>'+val+'</formula1></dataValidation>');
						else if (criteria=="<") validations.push('<dataValidation type="'+valid.type+'" errorStyle="'+type+'" operator="lessThan" allowBlank="0" showDropDown="0" showInputMessage="1" showErrorMessage="1" errorMessage="'+message+'" promptTitle="'+title+'" errorTitle="'+title+'" sqref="'+numAlpha(p)+ (n+1) +'"><formula1>'+val+'</formula1></dataValidation>');
						else if (criteria==">=") validations.push('<dataValidation type="'+valid.type+'" errorStyle="'+type+'" operator="greaterThanOrEqual" allowBlank="0" showDropDown="0" showInputMessage="1" showErrorMessage="1" errorMessage="'+message+'" promptTitle="'+title+'" errorTitle="'+title+'" sqref="'+numAlpha(p)+ (n+1) +'"><formula1>'+val+'</formula1></dataValidation>');
						else if (criteria=="<=") validations.push('<dataValidation type="'+valid.type+'" errorStyle="'+type+'" operator="lessThanOrEqual" allowBlank="0" showDropDown="0" showInputMessage="1" showErrorMessage="1" errorMessage="'+message+'" promptTitle="'+title+'" errorTitle="'+title+'" sqref="'+numAlpha(p)+ (n+1) +'"><formula1>'+val+'</formula1></dataValidation>');
						else if (criteria=="!=") validations.push('<dataValidation type="'+valid.type+'" errorStyle="'+type+'" operator="notEqual" allowBlank="0" showDropDown="0" showInputMessage="1" showErrorMessage="1" errorMessage="'+message+'" promptTitle="'+title+'" errorTitle="'+title+'" sqref="'+numAlpha(p)+ (n+1) +'"><formula1>'+val+'</formula1></dataValidation>');
						else if (criteria=="=") validations.push('<dataValidation type="'+valid.type+'" errorStyle="'+type+'" operator="equal" allowBlank="0" showDropDown="0" showInputMessage="1" showErrorMessage="1" errorMessage="'+message+'" promptTitle="'+title+'" errorTitle="'+title+'" sqref="'+numAlpha(p)+ (n+1) +'"><formula1>'+val+'</formula1></dataValidation>');
					}
